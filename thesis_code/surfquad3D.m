function [I] = surfquad3D(pe,ce,Nq,g)
...
switch Nq
    case 1
        z1 = Z(1/3,1/3,1/3);
        I(i) = A_k*g(z1)*z1'*ce(:,i);
    case 3
        z1 = Z(1/2,1/2,0);
        z2 = Z(1/2,0,1/2);
        z3 = Z(0,1/2,1/2);
        I(i) = A_k*(1/3)*(g(z1)*z1'*ce(:,i)+g(z2)*z2'*ce(:,i)+g(z3)*z3'*ce(:,i));
    case 4
        z1 = Z(1/3,1/3,1/3);
        z2 = Z(3/5,1/5,3/5);
        z3 = Z(1/5,3/5,1/5);
        z4 = Z(1/5,1/5,3/5);
        I(i) = -9/16*g(z1)*z1'*ce(:,i) +25/48*(g(z2)*z2'*ce(:,i)+g(z3)*z3'*ce(:,i)+g(z4)*z4'*ce(:,i));
        I(i) = I(i)*A_k;
    otherwise
        I(i) = NaN;
end
